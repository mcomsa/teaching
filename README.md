...
The course syllabus and slides can be downloaded [here](https://github.com/saschagobel/teaching/tree/master/slides/web-data-collection-with-r), R code is available [here](https://github.com/saschagobel/teaching/tree/master/slides/web-data-collection-with-r).
